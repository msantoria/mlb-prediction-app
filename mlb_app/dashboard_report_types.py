...
REPORT_TYPES: Dict[str, Dict[str, Any]] = {
    ...
    "model_projection_games": {"label": "Model Projections", "ui_object": "model_projections", "base_object": "model_projection_date_artifact", "population": {"row_type": "game"}, "relationships": ["model_projection_players"], "queryable": True, "workbench_queryable": True},
    "model_projection_players": {"label": "Model Projection Players", "ui_object": "model_projection_players", "base_object": "model_projection_date_artifact", "population": {"row_type": "player"}, "relationships": ["model_projection_games", "dashboard_player_current"], "queryable": True, "workbench_queryable": True},
    ...
    "player_trends": {"label": "Player Trends", "ui_object": "player_trends", "base_object": "player_trend_snapshots", "population": {"is_active": True, "player_type": "request_config"}, "relationships": ["dashboard_players", "statcast_events", "batter_id_rolling", "pitcher_id_rolling"], "queryable": True, "workbench_queryable": True},
}
