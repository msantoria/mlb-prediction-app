...
import { buildReportCsv, collectPaginatedRows, formatEasternDateTime, mlbDateIso, safeFilenamePart } from '../lib/dashboardReportUtils.mjs'
...
function ReportWorkspace({ open, close, objectMeta, result, fields, builderFields, generatedAt, reportDate, initialColumns, query, setQuery, reload, fetchAllRows, loading, onSave, isMobile }) {
  ...
  async function exportCsv() {
    ...
    try {
      ...
      downloadTextFile(`${safeFilenamePart(objectMeta.label)}-${reportDate}-all-rows.csv`, buildReportCsv({ columns: visible, rows: exportRows, fieldMap, getValue }), 'text/csv;charset=utf-8')
    } catch (err) {
